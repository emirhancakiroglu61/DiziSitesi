...
<h1 style="margin-left:40px; text-shadow: 1.5px 1.5px  #000;color: white; margin-top:20px;">Korku dizileri</h1>
<?php 
include("code/k.php");
?>
...
<center>
    <p><h1 style=" text-shadow: 1.5px 1.5px  #000;color: white; margin-top:20px;"  >Death Note Fragman</h1></p>
    
    <iframe style="border:3px solid black ;"  width="260" height="500" src="https://www.youtube.com/embed/NlJZ-YgAt-c?si=rxHTTtrLuNDH9P00" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

  <p><h1 style=" text-shadow: 1.5px 1.5px  #000;color: white; margin-top:20px;"  >Attak On Titan Fragman</h1></p>
  <iframe style="border:3px solid black ;" width="260" height="500"  src="https://www.youtube.com/embed/CbDSDOqMVO4?si=DAYN28wuXW3UOybd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
