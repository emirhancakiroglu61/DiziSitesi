...
<h1 style="Margin-left:35px;  text-shadow: 1.5px 1.5px  #000;color: white; margin-top:20px; "  > Kullanıcı  Giriş</h1>
...
<tr>
  ...
  <td><input class="textbox" type="password" placeholder="Şifreniz" name="ksif"></td>
</tr>
</table>
<br>
...
if(isset($_POST['Kadi']) && isset($_POST['ksif'])) {
  $kullanici_adi = $_POST['Kadi'];
  $sifre = $_POST['ksif'];

  // SQL sorgusu ile kullanıcı adı ve şifreyi kontrol et
  $sorgu = "SELECT * FROM persons WHERE kullanici_adi = '$kullanici_adi' AND passwor = '$sifre'";
